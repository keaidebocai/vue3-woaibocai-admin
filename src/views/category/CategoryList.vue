...
<template>
  <div>
    ...
    <el-dialog v-model="dialogVisible" title="添加标签" width="30%">
      <el-form label-width="115px" :model="insertCategory" style="max-width: 460px">
        ...
        <el-form-item label="icon_url">
          <el-input v-model="insertCategory.categoryIconUrl" />
        </el-form-item>
        <el-form-item label="url">
          <el-input v-model="insertCategory.categoryUrl" />
        </el-form-item>
        <el-form-item>
          <template #default>
